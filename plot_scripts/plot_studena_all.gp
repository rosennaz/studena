...
plot  '/home/rnz/Pictures/Pernik/scripts/plot_scripts/studena_for_plot.csv' using 1:($2/1000000) with boxes lc rgb  "blue"  # , 25519100 lc rgb "red" title "Dam Capacity"
